...
public class ControleurPendu implements InterfacePendu{
        //boutons
        @FXML
        Button a;
        @FXML Button b;
        ...
        //ListeView
        @FXML
        ListView<ObservableList<String>> liste;
        //menu
        @FXML
        MenuBar menu;
        ...
        public void init() throws RemoteException, MalformedURLException, NotBoundException {
            ...
            System.out.println("Mot a trouver: "+mot);
        ...
        public void menuClic(ActionEvent evt) {
            ...
            if ("Rejouer".equals(menuLabel)){
                ...
                try{
                    ...
                    Scene scene = new Scene(root,900,700); //redimmension auto
